...
export interface ContainerProps
  extends BoxProps,
    ...
    ElementProps<'div'> {
  /** Sets `max-width` of the container, value is not responsive – it is set for all screen sizes. Numbers are converted to rem `1rem = 16px`. Ignored when `fluid` prop is set. `'md'` by default */
