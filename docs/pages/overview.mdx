...
color scheme is `auto` (same as user system preferences), it can be changed by user and will be persisted in `localStorage`.

You can use configure default color scheme on [MantineProvider](/theming/mantine-provider):
