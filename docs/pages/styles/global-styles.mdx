...
`@mantine/core` package includes some global styles that are required for components to work.
...
end with `.module.css`, if you want to add global styles to your application, create file with
