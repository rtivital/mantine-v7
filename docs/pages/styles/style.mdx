...
You can pass style object to `style` prop – in this case it works the same way
...
You can pass style function to `style` prop – in this case it will be called with [theme](/theming/theme-object/).
...
You can pass array of style objects and/or functions to `style` prop – in this case all styles will be merged together.
It is useful when you want to create a wrapper around Mantine component, add inline styles and keep option to pass
`style` prop to it.
