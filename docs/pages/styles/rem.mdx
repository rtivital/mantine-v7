...
All components scale based on user's browser font-size settings or font-size of `html`/`:root`.
...
For example, if you want to set `html` font-size to `10px` and scale Mantine components accordingly, you need
