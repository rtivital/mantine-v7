...
in different variants in the following components: [Button](/core/button), [Badge](/core/badge), [ActionIcon](/core/action-icon) and [ThemeIcon](/core/theme-icon).
...
You can use [colors generator](/colors-generator) to generate 10 shades of color based on single value
...
The package exports `generateColors` function that accepts color value and returns an array of 10 shades.
