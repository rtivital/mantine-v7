...
`MantineThemeProvider` allows you to override [theme](/theming/theme-object) values for a subtree of components.
...
>
> It is not recommended to have more that one `MantineProvider` in your application, but you can have as many `MantineThemeProvider` as you need.
