...
export const MDX_DATES_DATA: Record<string, Frontmatter> = {
  Calendar: {
    ...
    props: ['Calendar'],
    styles: ['Calendar'],
    import: "import { Calendar } from '@mantine/core';",
  ...
  DateInput: {
    ...
    props: ['DateInput'],
    styles: ['DateInput'],
    import: "import { DateInput } from '@mantine/core';",
  ...
  DatePicker: {
    ...
    props: ['DatePicker'],
    styles: ['DatePicker'],
    import: "import { DatePicker } from '@mantine/core';",
  ...
  DatePickerInput: {
    ...
    import: "import { DatePickerInput } from '@mantine/core';",
  ...
  DatesProvider: {
    ...
    import: "import { DatesProvider } from '@mantine/core';",
  ...
  DateTimePicker: {
    ...
    import: "import { DateTimePicker } from '@mantine/core';",
  ...
  MonthPicker: {
    ...
    import: "import { MonthPicker } from '@mantine/core';",
  ...
  MonthPickerInput: {
    ...
    import: "import { MonthPickerInput } from '@mantine/core';",
  ...
  TimeInput: {
    ...
    import: "import { TimeInput } from '@mantine/core';",
  ...
  YearPicker: {
    ...
    import: "import { YearPicker } from '@mantine/core';",
  ...
  YearPickerInput: {
    ...
    description: 'Inline year, multiple years and years range picker',
    import: "import { YearPickerInput } from '@mantine/core';",
