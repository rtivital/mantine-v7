    ...
    <>
      <div className={classes.groupsHeader}>
        ...
        <MdxParagraph style={{ marginTop: 0 }}>
          ...
          <MdxLink href="/styles/styles-api">Styles API</MdxLink>. With Styles API you can customize
          styles of any inner element. Follow{' '}
          <MdxLink href="/styles/styles-api">documentation</MdxLink> to lean how to use CSS modules,
          CSS variables and inline styles to get full control over components styles.
        </MdxParagraph>
      </div>
      {tables}
    </>
