...
`,u={type:"code",component:function(){let{setColorScheme:e}=(0,l.X)(),n=(0,i.l)("light",{getInitialValueInEffect:!0});return o.createElement(c.A,{onClick:()=>e("light"===n?"dark":"light"),variant:"default",size:"xl","aria-label":"Toggle color scheme"},o.createElement(r.Z,{className:(0,s.Z)(d.icon,d.light),stroke:1.5}),o.createElement(a.Z,{className:(0,s.Z)(d.icon,d.dark),stroke:1.5}))},centered:!0,code:[{fileName:"Demo.tsx",language:"tsx",code:h},{fileName:"Demo.module.css",language:"css",code:m}]}}},function(e){e.O(0,[5664,9341,4831,9774,2888,179],function(){return e(e.s=92414)}),_N_E=e.O()}]);