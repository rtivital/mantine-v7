...
`,x={type:"code",component:function(){return i.createElement(c.x,{w:300,h:200},i.createElement(s.x,{w:600},i.createElement(d,null)))},centered:!0,code:w};var k=r(25943),j=r(2857);let S=`
...
`,E={type:"code",component:function(){let[e,t]=(0,i.useState)({x:0,y:0});return i.createElement(k.K,{align:"center"},i.createElement(c.x,{w:300,h:200,onScrollPositionChange:t},i.createElement(s.x,{w:600},i.createElement(d,null))),i.createElement(u.x,null,"Scroll position: ",i.createElement(j.E,null,`{ x: ${e.x}, y: ${e.y} }`)))},code:S};var A=r(74378),C=r(43406);let M=`
...
`,z={type:"code",component:function(){let e=(0,i.useRef)(null),t=()=>e.current.scrollTo({top:e.current.scrollHeight,behavior:"smooth"}),r=()=>e.current.scrollTo({top:e.current.scrollHeight/2,behavior:"smooth"}),o=()=>e.current.scrollTo({top:0,behavior:"smooth"});return i.createElement(k.K,{align:"center"},i.createElement(c.x,{w:300,h:200,viewportRef:e},i.createElement(d,null)),i.createElement(A.Z,{justify:"center"},i.createElement(C.z,{onClick:t,variant:"outline"},"Scroll to bottom"),i.createElement(C.z,{onClick:r,variant:"outline"},"Scroll to center"),i.createElement(C.z,{onClick:o,variant:"outline"},"Scroll to top")))},code:M};var T={scrollbar:"mantine-rUYw6F-",thumb:"mantine-c1tUz1t",corner:"mantine-2RjwQm-"};let B=`
import { ScrollArea, Box } from '@mantine/core';
...
`,I={type:"code",component:function(){return i.createElement(c.x,{w:300,h:200,type:"always",offsetScrollbars:!0,classNames:T},i.createElement(s.x,{w:600},i.createElement(d,null)))},centered:!0,code:[{fileName:"Demo.tsx",code:B,language:"tsx"},{fileName:"Demo.module.css",code:P,language:"css"}]};var Z=r(34525);let O=`
