...
`,Z={type:"configurator",component:function(e){return l.createElement(j.Z,{justify:"center"},l.createElement(d.z,{size:e.size},"Regular ",e.size),l.createElement(d.z,{size:`compact-${e.size}`},"Compact ",e.size))},code:I,centered:!0,controls:[{type:"size",prop:"size",initialValue:"md",libraryValue:"__none__"}]};var G=n(55127);let T=e=>`
import { Button } from '@mantine/core';
