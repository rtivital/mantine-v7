...
`,b={type:"code",component:function(){return i.createElement(c.x,{w:300,h:200},i.createElement(s.x,{w:600},i.createElement(d,null)))},centered:!0,code:x};var k=r(25943),S=r(2857);let C=`
...
`,j={type:"code",component:function(){let[e,t]=(0,i.useState)({x:0,y:0});return i.createElement(k.K,{align:"center"},i.createElement(c.x,{w:300,h:200,onScrollPositionChange:t},i.createElement(s.x,{w:600},i.createElement(d,null))),i.createElement(u.x,null,"Scroll position: ",i.createElement(S.E,null,`{ x: ${e.x}, y: ${e.y} }`)))},code:C};var A=r(74378),E=r(55899);let B=`
...
`,T={type:"code",component:function(){let e=(0,i.useRef)(null),t=()=>e.current.scrollTo({top:e.current.scrollHeight,behavior:"smooth"}),r=()=>e.current.scrollTo({top:e.current.scrollHeight/2,behavior:"smooth"}),o=()=>e.current.scrollTo({top:0,behavior:"smooth"});return i.createElement(k.K,{align:"center"},i.createElement(c.x,{w:300,h:200,viewportRef:e},i.createElement(d,null)),i.createElement(A.Z,{justify:"center"},i.createElement(E.z,{onClick:t,variant:"outline"},"Scroll to bottom"),i.createElement(E.z,{onClick:r,variant:"outline"},"Scroll to center"),i.createElement(E.z,{onClick:o,variant:"outline"},"Scroll to top")))},code:B};var I={scrollbar:"m-3dc2e23a",thumb:"m-b848b7ea",corner:"m-342d2ec1"};let P=`
import { ScrollArea, Box } from '@mantine/core';
...
`,M={type:"code",component:function(){return i.createElement(c.x,{w:300,h:200,type:"always",offsetScrollbars:!0,classNames:I},i.createElement(s.x,{w:600},i.createElement(d,null)))},centered:!0,code:[{fileName:"Demo.tsx",code:P,language:"tsx"},{fileName:"Demo.module.css",code:D,language:"css"}]};var z=r(90395),R=r(31577);let O=`
...
`,Z={type:"code",component:function(){let[e,t]=(0,H.C)(3,{min:0,max:10}),r=Array(e).fill(0).map((e,t)=>i.createElement("p",{key:t},"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dicta perspiciatis reiciendis voluptate eaque itaque quos. Natus iure tenetur libero, reprehenderit ad, sequi, in aliquam eos necessitatibus expedita delectus veniam culpa!"));return i.createElement(i.Fragment,null,i.createElement(c.x.Autosize,{mah:300,maw:400,mx:"auto"},r),i.createElement(A.Z,{justify:"center",mt:"md"},i.createElement(E.z,{variant:"outline",color:"red",onClick:t.decrement},"Remove paragraph"),i.createElement(E.z,{variant:"outline",onClick:t.increment},"Add paragraph")))},code:V};var N=r(87810);let _=`
import { useState, useRef } from 'react';
