...
`,E={type:"code",component:function(){return l.createElement(y.Z,{justify:"center"},l.createElement(d.z,{leftSection:l.createElement(x.Z,{size:14}),variant:"default"},"Gallery"),l.createElement(d.z,{rightSection:l.createElement(B.Z,{size:14})},"Download"),l.createElement(d.z,{variant:"light",leftSection:l.createElement(x.Z,{size:14}),rightSection:l.createElement(w.Z,{size:14,className:"mantine-rotate-rtl"})},"Visit gallery"))},code:z};var D=Object.defineProperty,S=Object.getOwnPropertySymbols,O=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable,C=(e,t,n)=>t in e?D(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,k=(e,t)=>{for(var n in t||(t={}))O.call(t,n)&&C(e,n,t[n]);if(S)for(var n of S(t))P.call(t,n)&&C(e,n,t[n]);return e};let _=e=>`
import { Button } from '@mantine/core';
...
`,V={type:"configurator",component:function(e){return l.createElement(y.Z,{justify:"center"},l.createElement(d.z,{size:e.size},"Regular ",e.size),l.createElement(d.z,{size:`compact-${e.size}`},"Compact ",e.size))},code:T,centered:!0,controls:[{type:"size",prop:"size",initialValue:"md",libraryValue:"__none__"}]};var I=n(55127);let N=e=>`
import { Button } from '@mantine/core';
...
`,R={type:"configurator",component:function(e){return l.createElement(d.z,{variant:"gradient",gradient:{from:e.gradientFrom,to:e.gradientTo,deg:e.gradientDegree}},"Gradient button")},code:N,centered:!0,controls:I.P},F=`
import { Button } from '@mantine/core';

function Demo() {
  return <Button disabled>Disabled button</Button>;
}
`,$={type:"code",component:function(){return l.createElement(d.z,{disabled:!0},"Disabled button")},centered:!0,code:F},L=`
import { Button } from '@mantine/core';
...
`,W={type:"code",component:function(){return l.createElement(d.z,{component:"a",href:"https://mantine.dev","data-disabled":!0,onClick:e=>e.preventDefault()},"Disabled link")},centered:!0,code:L};var Z={button:"m-13d58bb2"};let A=`
import { Button } from '@mantine/core';
...
`,Y={type:"code",component:function(){return l.createElement(d.z,{className:Z.button,disabled:!0},"Disabled with styles")},centered:!0,code:[{fileName:"Demo.module.css",code:M,language:"css"},{fileName:"Demo.tsx",code:A,language:"tsx"}]};var H=n(41283);let U=`
...
`,J={type:"code",component:function(){return l.createElement(y.Z,null,l.createElement(d.z,{loading:!0},"Filled button"),l.createElement(d.z,{variant:"light",loading:!0},"Light button"),l.createElement(d.z,{variant:"outline",loading:!0},"Outline button"))},centered:!0,code:q},K=`
import { Button } from '@mantine/core';
