...
`,I={xs:(0,s.h)(12),sm:(0,s.h)(14),md:(0,s.h)(18),lg:(0,s.h)(26),xl:(0,s.h)(34)},A={type:"configurator",component:function(e){return c.createElement(d.A,j(g({},e),{"aria-label":"Settings"}),c.createElement(l,{style:{width:I[e.size],height:I[e.size]},stroke:1.5}))},code:v,centered:!0,striped:!0,controls:[h.cH,{prop:"color",type:"color",initialValue:"blue",libraryValue:"blue"},{prop:"size",type:"size",initialValue:"md",libraryValue:"md"},{prop:"radius",type:"size",initialValue:"sm",libraryValue:"sm"}]};var w=t(1002),k=t(55127);let z=e=>`
import { ActionIcon } from '@mantine/core';
...
`,E={type:"configurator",component:function(e){return c.createElement(d.A,{variant:"gradient",size:"xl","aria-label":"Gradient action icon",gradient:{from:e.gradientFrom,to:e.gradientTo,deg:e.gradientDegree}},c.createElement(w.Z,null))},code:z,centered:!0,controls:k.P},D=`
...
`,M={type:"code",component:function(){return c.createElement(H.Z,{justify:"center"},c.createElement(d.A,{size:"xl",disabled:!0,"aria-label":"Disabled and not interactive"},c.createElement(w.Z,null)),c.createElement(d.A,{size:"xl","data-disabled":!0,"aria-label":"Has disabled styles but still interactive"},c.createElement(w.Z,null)))},code:T};var P=t(31550);let Z=`
import { ActionIcon } from '@mantine/core';
...
`,G={type:"code",component:function(){return c.createElement(d.A,{component:"a",href:"https://mantine.dev","data-disabled":!0,size:"xl","aria-label":"Open in a new tab",onClick:e=>e.preventDefault()},c.createElement(P.Z,null))},centered:!0,code:Z};var N={button:"mantine-f4gt-54"};let O=`
import { ActionIcon } from '@mantine/core';
import { IconHeart } from '@tabler/icons-react';
...
`,C={type:"code",component:function(){return c.createElement(d.A,{size:"xl",className:N.button,disabled:!0,"aria-label":"Disabled with styles"},c.createElement(w.Z,null))},centered:!0,code:[{fileName:"Demo.module.css",code:V,language:"css"},{fileName:"Demo.tsx",code:O,language:"tsx"}]};var L=t(41283);let S=`
