...
`,S=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],F={type:"code",component:function(){let o=(0,i.K)({onDropdownClose:()=>o.resetSelectedOption()}),[e,t]=(0,c.useState)(null),[n,r]=(0,c.useState)(""),l=S.every(o=>o!==n),a=l?S.filter(o=>o.toLowerCase().includes(n.toLowerCase().trim())):S,s=a.map(o=>c.createElement(p.h.Option,{value:o,key:o},o));return c.createElement(p.h,{store:o,onOptionSubmit:e=>{t(e),r(e),o.closeDropdown()}},c.createElement(p.h.Target,null,c.createElement(O.M,{rightSection:c.createElement(p.h.Chevron,null),onClick:()=>o.openDropdown(),onFocus:()=>o.openDropdown(),onBlur:()=>{o.closeDropdown(),r(e||"")},placeholder:"Search value",value:n,onChange:e=>{o.updateSelectedOptionIndex(),r(e.currentTarget.value)}})),c.createElement(p.h.Dropdown,null,c.createElement(p.h.Options,null,s.length>0?s:c.createElement(p.h.Empty,null,"Nothing found"))))},maxWidth:340,centered:!0,defaultExpanded:!1,code:E},D=`
import { useState } from 'react';
import { Button, Combobox, useCombobox, Text, Box } from '@mantine/core';
