(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[931],{90653:function(e,n,t){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/action-icon",function(){return t(17798)}])},17798:function(e,n,t){"use strict";t.r(n),t.d(n,{default:function(){return Q}});var o=t(85893),i=t(11151),a=t(34940),r=t(25263),c=t(67294),l=(0,t(54764).Z)("adjustments","IconAdjustments",[["path",{d:"M4 10a2 2 0 1 0 4 0a2 2 0 0 0 -4 0",key:"svg-0"}],["path",{d:"M6 4v4",key:"svg-1"}],["path",{d:"M6 12v8",key:"svg-2"}],["path",{d:"M10 16a2 2 0 1 0 4 0a2 2 0 0 0 -4 0",key:"svg-3"}],["path",{d:"M12 4v10",key:"svg-4"}],["path",{d:"M12 18v2",key:"svg-5"}],["path",{d:"M16 7a2 2 0 1 0 4 0a2 2 0 0 0 -4 0",key:"svg-6"}],["path",{d:"M18 4v1",key:"svg-7"}],["path",{d:"M18 9v11",key:"svg-8"}]]),s=t(46393),d=t(80194),h=t(12572);let u=`
...
`,m={xs:(0,s.h)(12),sm:(0,s.h)(14),md:(0,s.h)(18),lg:(0,s.h)(26),xl:(0,s.h)(34)},p={type:"configurator",component:function(e){return c.createElement(d.A,Object.assign({},e,{"aria-label":"Settings"}),c.createElement(l,{style:{width:m[e.size],height:m[e.size]},stroke:1.5}))},code:u,centered:!0,striped:!0,controls:[h.cH,{prop:"color",type:"color",initialValue:"blue",libraryValue:"blue"},{prop:"size",type:"size",initialValue:"md",libraryValue:"md"},{prop:"radius",type:"size",initialValue:"sm",libraryValue:"sm"}]};var b=t(1002),x=t(55127);let f=e=>`
import { ActionIcon } from '@mantine/core';
...
`,g={type:"configurator",component:function(e){return c.createElement(d.A,{variant:"gradient",size:"xl","aria-label":"Gradient action icon",gradient:{from:e.gradientFrom,to:e.gradientTo,deg:e.gradientDegree}},c.createElement(b.Z,null))},code:f,centered:!0,controls:x.P},j=`
...
`,v={type:"code",centered:!0,component:function(){return c.createElement(d.A,{size:42,variant:"default","aria-label":"ActionIcon with size as a number"},c.createElement(b.Z,{style:{width:(0,s.h)(24),height:(0,s.h)(24)}}))},code:j};var I=t(74378);let y=`
...
`,A={type:"code",component:function(){return c.createElement(I.Z,{justify:"center"},c.createElement(d.A,{size:"xl",disabled:!0,"aria-label":"Disabled and not interactive"},c.createElement(b.Z,null)),c.createElement(d.A,{size:"xl","data-disabled":!0,"aria-label":"Has disabled styles but still interactive"},c.createElement(b.Z,null)))},code:y};var k=t(31550);let z=`
import { ActionIcon } from '@mantine/core';
...
`,w={type:"code",component:function(){return c.createElement(d.A,{component:"a",href:"https://mantine.dev","data-disabled":!0,size:"xl","aria-label":"Open in a new tab",onClick:e=>e.preventDefault()},c.createElement(k.Z,null))},centered:!0,code:z};var E={button:"mantine-f4gt-54"};let D=`
import { ActionIcon } from '@mantine/core';
import { IconHeart } from '@tabler/icons-react';
...
`,H={type:"code",component:function(){return c.createElement(d.A,{size:"xl",className:E.button,disabled:!0,"aria-label":"Disabled with styles"},c.createElement(b.Z,null))},centered:!0,code:[{fileName:"Demo.module.css",code:_,language:"css"},{fileName:"Demo.tsx",code:D,language:"tsx"}]};var T=t(41283);let M=`
...
`,Z={type:"code",component:function(){return c.createElement(T.u,{label:"Tooltip for disabled button"},c.createElement(d.A,{size:"xl","data-disabled":!0,onClick:e=>e.preventDefault()},c.createElement(b.Z,null)))},centered:!0,code:M},G=`
import { ActionIcon, Group } from '@mantine/core';
...
`,N={type:"code",component:function(){return c.createElement(I.Z,{justify:"center"},c.createElement(d.A,{loading:!0,"aria-label":"Filled loading"}),c.createElement(d.A,{variant:"light",loading:!0,"aria-label":"Light loading"}),c.createElement(d.A,{variant:"outline",loading:!0,"aria-label":"Outline loading"}))},code:G},V=`
import { ActionIcon } from '@mantine/core';

function Demo() {
  return <ActionIcon size="xl" loading loaderProps={{ type: 'dots' }} />;
}
`,P={type:"code",component:function(){return c.createElement(d.A,{size:"xl",loading:!0,loaderProps:{type:"dots"}})},centered:!0,code:V};var C=t(39242),L=t(49441);let S=`
...
`,F=(0,C.j)({components:{ActionIcon:d.A.extend({classNames:{root:"mantine-N-KPnGR"}})}}),W={type:"code",component:function(){return c.createElement(L.M2,{theme:F},c.createElement(I.Z,{justify:"center"},c.createElement(d.A,{size:"xl",variant:"danger","aria-label":"Danger variant"},c.createElement(b.Z,null)),c.createElement(d.A,{size:"xl",variant:"primary","aria-label":"Primary variant"},c.createElement(b.Z,null))))},centered:!0,code:[{fileName:"Demo.tsx",code:S,language:"tsx"},{fileName:"Demo.module.css",code:O,language:"css"}]};var $=t(78708),R=t(60060),U=t(17569);let X=`
import { ActionIcon, rem } from '@mantine/core';
