...
`,p={type:"code",code:h,centered:!0,component:function(){let[e,{open:t,close:n}]=(0,d.q)(!1);return s.createElement(s.Fragment,null,s.createElement(a.d,{opened:e,onClose:n,title:"Authentication"},s.createElement(u._,{noShadow:!0,noPadding:!0})),s.createElement(i.z,{onClick:t},"Open Drawer"))}};var m=n(74378);let f={type:"code",component:function(){let[e,t]=(0,s.useState)(!1),[n,r]=(0,s.useState)("top"),o=e=>{r(e),t(!0)};return s.createElement(s.Fragment,null,s.createElement(a.d,{opened:e,onClose:()=>t(!1),padding:"md",position:n,withCloseButton:!1},"Press escape to close the drawer"),s.createElement(m.Z,{justify:"center"},s.createElement(i.z,{variant:"outline",onClick:()=>o("left")},"Left"),s.createElement(i.z,{variant:"outline",onClick:()=>o("right")},"Right"),s.createElement(i.z,{variant:"outline",onClick:()=>o("top")},"Top"),s.createElement(i.z,{variant:"outline",onClick:()=>o("bottom")},"Bottom")))}},w=`
import { useDisclosure } from '@mantine/hooks';
import { Drawer, Button } from '@mantine/core';
...
`,v={type:"code",code:D,centered:!0,component:function(){let[e,{open:t,close:n}]=(0,d.q)(!1),r=Array(100).fill(0).map((e,t)=>s.createElement("p",{key:t},"Drawer with scroll"));return s.createElement(s.Fragment,null,s.createElement(a.d,{opened:e,onClose:n,title:"Header is sticky"},r),s.createElement(i.z,{onClick:t},"Open drawer"))}};var k=n(45906);let b=`
import { useDisclosure } from '@mantine/hooks';
