...
`,Z={type:"code",centered:!0,component:function(){return c.createElement(d.A,{size:42,variant:"default","aria-label":"ActionIcon with size as a number"},c.createElement(k.Z,{style:{width:(0,s.h)(24),height:(0,s.h)(24)}}))},code:M};var D=t(74378);let _=`
...
`,H={type:"code",component:function(){return c.createElement(D.Z,{justify:"center"},c.createElement(d.A,{size:"xl",disabled:!0,"aria-label":"Disabled and not interactive"},c.createElement(k.Z,null)),c.createElement(d.A,{size:"xl","data-disabled":!0,"aria-label":"Has disabled styles but still interactive"},c.createElement(k.Z,null)))},code:_};var P=t(31550);let T=`
import { ActionIcon } from '@mantine/core';
...
`,G={type:"code",component:function(){return c.createElement(d.A,{component:"a",href:"https://mantine.dev","data-disabled":!0,size:"xl","aria-label":"Open in a new tab",onClick:e=>e.preventDefault()},c.createElement(P.Z,null))},centered:!0,code:T};var N={button:"mantine-f4gt-54"};let O=`
import { ActionIcon } from '@mantine/core';
import { IconHeart } from '@tabler/icons-react';
...
`,L={type:"code",component:function(){return c.createElement(d.A,{size:"xl",className:N.button,disabled:!0,"aria-label":"Disabled with styles"},c.createElement(k.Z,null))},centered:!0,code:[{fileName:"Demo.module.css",code:V,language:"css"},{fileName:"Demo.tsx",code:O,language:"tsx"}]};var C=t(41283);let S=`
...
`,F={type:"code",component:function(){return c.createElement(C.u,{label:"Tooltip for disabled button"},c.createElement(d.A,{size:"xl","data-disabled":!0,onClick:e=>e.preventDefault()},c.createElement(k.Z,null)))},centered:!0,code:S},R=`
import { ActionIcon, Group } from '@mantine/core';
...
`,W={type:"code",component:function(){return c.createElement(D.Z,{justify:"center"},c.createElement(d.A,{loading:!0,"aria-label":"Filled loading"}),c.createElement(d.A,{variant:"light",loading:!0,"aria-label":"Light loading"}),c.createElement(d.A,{variant:"outline",loading:!0,"aria-label":"Outline loading"}))},code:R},$=`
import { ActionIcon } from '@mantine/core';

function Demo() {
  return <ActionIcon size="xl" loading loaderProps={{ type: 'dots' }} />;
}
`,U={type:"code",component:function(){return c.createElement(d.A,{size:"xl",loading:!0,loaderProps:{type:"dots"}})},centered:!0,code:$};var X=t(39242),Y=t(49441);let q=`
