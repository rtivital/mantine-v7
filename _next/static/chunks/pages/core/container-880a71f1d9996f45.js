...
`,C={type:"code",component:function(){let e={bg:"var(--mantine-color-blue-light)",h:50,mt:"md"};return a.createElement(a.Fragment,null,a.createElement(c.W,f(x({},e),{mt:0}),"Default Container"),a.createElement(c.W,x({size:"xs"},e),"xs Container"),a.createElement(c.W,f(x({px:0,size:"30rem"},e),{mt:"md"}),"30rem Container without padding"))},code:g},y=`
import { Container } from '@mantine/core';
...
`,j={type:"code",component:function(){return a.createElement(c.W,{fluid:!0,h:50,bg:"var(--mantine-color-blue-light)"},"Fluid container has 100% max-width")},code:y};var w=t(46393),b=t(39242),k=t(49441);let M=`
