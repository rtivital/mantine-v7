...
`,Z=e=>{var{indeterminate:t}=e,n=X(e,["indeterminate"]);return t?l.createElement(O,S({},n)):l.createElement(E,S({},n))},D={type:"code",component:function(){return l.createElement(l.Fragment,null,l.createElement(i.X,{icon:Z,label:"Custom icon",defaultChecked:!0}),l.createElement(i.X,{icon:Z,label:"Custom icon: indeterminate",indeterminate:!0,mt:"sm"}))},code:R};var _=n(77092),G=n(46342);let A=`
