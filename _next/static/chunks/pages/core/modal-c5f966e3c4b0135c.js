...
`,x={type:"code",code:f,centered:!0,component:function(){let[e,{open:n,close:o}]=(0,c.q)(!1);return s.createElement(s.Fragment,null,s.createElement(d.u,{opened:e,onClose:o,withCloseButton:!1},"Modal without header, press escape or click on overlay to close"),s.createElement(u.z,{onClick:n},"Open Modal"))}};var j=o(74378);let y=["xs","sm","md","lg","xl","55rem","70%","100%"],M={type:"code",component:function(){let[e,n]=(0,s.useState)(!1),[o,t]=(0,s.useState)("md"),l=y.map(e=>s.createElement(u.z,{key:e,variant:"outline",onClick:()=>{t(e),n(!0)}},e));return s.createElement(s.Fragment,null,s.createElement(d.u,{opened:e,onClose:()=>n(!1),title:"Introduce yourself!",size:o},s.createElement(m._,{noPadding:!0,noShadow:!0})),s.createElement(j.Z,{justify:"center"},l))}};var b=o(34525),g=o(23733),C=o(77048);let w=`
