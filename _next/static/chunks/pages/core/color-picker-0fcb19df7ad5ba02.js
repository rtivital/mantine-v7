...
`,T={type:"configurator",component:function(e){return l.createElement(s.z,S({mx:"auto",format:"hex",defaultValue:"rgba(50, 151, 194, 1)",swatches:Object.keys(j.t.colors).map(e=>j.t.colors[e][6])},e))},code:z,controls:[{prop:"swatchesPerRow",type:"number",initialValue:7,libraryValue:7,min:5,max:12}]};var L=r(92259);let _=`
import { useState } from 'react';
...
`,D={type:"code",component:function(){let[e,t]=(0,l.useState)("#fff");return l.createElement(L.x,{maw:200,mx:"auto"},l.createElement(s.z,{format:"hex",value:e,onChange:t,withPicker:!1,fullWidth:!0,swatches:[...j.t.colors.red.slice(0,7),...j.t.colors.green.slice(0,7),...j.t.colors.blue.slice(0,7)]}),l.createElement(d.x,{ta:"center",mt:5},e))},code:_};var A=Object.defineProperty,Z=Object.getOwnPropertySymbols,I=Object.prototype.hasOwnProperty,H=Object.prototype.propertyIsEnumerable,V=(e,t,r)=>t in e?A(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,W=(e,t)=>{for(var r in t||(t={}))I.call(t,r)&&V(e,r,t[r]);if(Z)for(var r of Z(t))H.call(t,r)&&V(e,r,t[r]);return e};let B=`
import { ColorPicker } from '@mantine/core';
