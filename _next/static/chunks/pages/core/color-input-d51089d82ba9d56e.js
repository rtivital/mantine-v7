...
`,D={type:"code",component:function(){return i.createElement(s.T,{maw:320,mx:"auto",disallowInput:!0,placeholder:"Pick color",label:"Your favorite color"})},code:V};var M=t(5037);let z=`
import { ColorInput } from '@mantine/core';
...
`,S={type:"code",component:function(){return i.createElement(s.T,{maw:320,mx:"auto",placeholder:"Pick color",label:"Your favorite color",swatches:Object.keys(M.t.colors).map(e=>M.t.colors[e][6])})},code:z};var T=t(23251);let _=`
...
`,R={type:"code",component:function(){return i.createElement(s.T,{disabled:!0,label:"Disabled input",placeholder:"Disabled input"})},maxWidth:340,centered:!0,code:Z};var L=t(93396);let W=`
