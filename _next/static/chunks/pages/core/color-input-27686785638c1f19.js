...
`,D={type:"code",component:function(){return i.createElement(s.T,{maw:320,mx:"auto",disallowInput:!0,placeholder:"Pick color",label:"Your favorite color"})},code:V};var M=t(5037);let S=`
import { ColorInput } from '@mantine/core';
...
`,z={type:"code",component:function(){return i.createElement(s.T,{maw:320,mx:"auto",placeholder:"Pick color",label:"Your favorite color",swatches:Object.keys(M.t.colors).map(e=>M.t.colors[e][6])})},code:S};var T=t(23251);let _=`
