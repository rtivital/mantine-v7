...
`,w={type:"code",component:function(){return l.createElement(i.K,{align:"center"},l.createElement(s.z,{format:"hex",defaultValue:"rgba(50, 151, 194, 1)",swatches:Object.keys(j.t.colors).map(e=>j.t.colors[e][6])}))},code:k};var P=r(23251),E=r(51227);let C=`
import { useState } from 'react';
...
`,I={type:"code",component:function(){return l.createElement(s.z,{fullWidth:!0,size:"lg",format:"rgba"})},code:Z};var H=r(33512),V=Object.defineProperty,W=Object.getOwnPropertySymbols,B=Object.prototype.hasOwnProperty,N=Object.prototype.propertyIsEnumerable,F=(e,t,r)=>t in e?V(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,R=(e,t)=>{for(var r in t||(t={}))B.call(t,r)&&F(e,r,t[r]);if(W)for(var r of W(t))N.call(t,r)&&F(e,r,t[r]);return e};let U=`
import { ColorPicker } from '@mantine/core';
