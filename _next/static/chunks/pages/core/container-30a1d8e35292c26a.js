...
`,y={type:"code",component:function(){let e={bg:"var(--mantine-color-blue-light)",h:50,mt:"md"};return a.createElement(a.Fragment,null,a.createElement(c.W,g(x({},e),{mt:0}),"Default Container"),a.createElement(c.W,x({size:"xs"},e),"xs Container"),a.createElement(c.W,g(x({px:0,size:"30rem"},e),{mt:"md"}),"30rem Container without padding"))},code:f},C=`
import { Container } from '@mantine/core';
...
`,j={type:"code",component:function(){return a.createElement(c.W,{fluid:!0,h:50,bg:"var(--mantine-color-blue-light)"},"Fluid container has 100% max-width")},code:C};var w=t(46393),k=t(39242),b=t(49441);let M=`
...
`,z={xxs:(0,w.h)(300),xs:(0,w.h)(400),sm:(0,w.h)(500),md:(0,w.h)(600),lg:(0,w.h)(700),xl:(0,w.h)(800),xxl:(0,w.h)(900)},E=(0,k.j)({components:{Container:c.W.extend({vars:(e,{size:n,fluid:t})=>({root:{"--container-size":t?"100%":void 0!==n&&n in z?z[n]:(0,w.h)(n)}})})}}),Z={type:"code",component:function(){return a.createElement(b.M2,{theme:E},a.createElement(c.W,{size:"xxs",bg:"var(--mantine-color-blue-light)"},"Container with custom size"))},code:M};var P=t(38944),N={responsiveContainer:"mantine-88drGXg"};let _=`
import cx from 'clsx';
