...
`,x={type:"code",code:f,centered:!0,component:function(){let[e,{open:n,close:t}]=(0,c.q)(!1);return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:t,withCloseButton:!1},"Modal without header, press escape or click on overlay to close"),i.createElement(u.z,{onClick:n},"Open Modal"))}};var j=t(74378);let M=["xs","sm","md","lg","xl","55rem","70%","100%"],y={type:"code",component:function(){let[e,n]=(0,i.useState)(!1),[t,o]=(0,i.useState)("md"),l=M.map(e=>i.createElement(u.z,{key:e,variant:"outline",onClick:()=>{o(e),n(!0)}},e));return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:()=>n(!1),title:"Introduce yourself!",size:t},i.createElement(m._,null)),i.createElement(j.Z,{justify:"center"},l))}};var v=t(34525),g=t(23733),k=t(77048);let b=`
...
`,C={type:"code",component:function(){let[e,{close:n,open:t}]=(0,c.q)(!1),[o,{increment:l,decrement:r}]=(0,v.C)(3,{min:0}),a=Array(o).fill(0).map((e,n)=>i.createElement(g.C,{key:n},"Badge ",n));return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:n,size:"auto",title:"Modal size auto"},i.createElement(k.x,null,"Modal with size auto will fits its content"),i.createElement(j.Z,{wrap:"nowrap",mt:"md"},a),i.createElement(j.Z,{mt:"xl"},i.createElement(u.z,{variant:"outline",onClick:l},"Add badge"),i.createElement(u.z,{variant:"outline",onClick:r},"Remove badge"))),i.createElement(u.z,{onClick:t},"Open modal"))},centered:!0,code:b},w=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
...
`,E={type:"code",code:w,centered:!0,component:function(){let[e,{open:n,close:t}]=(0,c.q)(!1);return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:t,title:"This is a fullscreen modal",fullScreen:!0,transitionProps:{transition:"fade",duration:200}},i.createElement(k.x,{mb:"xl"},"It takes the entire screen and does not not have overlay and border-radius, you can use it small screens to save up some space. It also has fade transition by default, but you can change that with transition prop. Now here is an authentication form used in previous examples to see the difference."),i.createElement(m._,null)),i.createElement(u.z,{onClick:n},"Open Modal"))}};var O=t(18248),B=t(46393);let z=`
...
`,D={type:"code",code:z,centered:!0,component:function(){let[e,{open:n,close:t}]=(0,c.q)(!1),o=(0,O.a)(`(max-width: ${(0,B.em)(800)})`);return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:t,title:"This is a fullscreen modal",fullScreen:o,transitionProps:{transition:"fade",duration:200}},"The Modal will be full screen only on mobile"),i.createElement(u.z,{onClick:n},"Open Modal"))}},T=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
...
`,S={type:"code",code:F,centered:!0,component:function(){let[e,{open:n,close:t}]=(0,c.q)(!1),o=Array(100).fill(0).map((e,n)=>i.createElement("p",{key:n},"Modal with scroll"));return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:t,title:"Header is sticky"},o),i.createElement(u.z,{onClick:n},"Open modal"))}};var P=t(45906);let I=`
import { useDisclosure } from '@mantine/hooks';
...
`,_={type:"code",code:I,centered:!0,component:function(){let[e,{open:n,close:t}]=(0,c.q)(!1),o=Array(100).fill(0).map((e,n)=>i.createElement("p",{key:n},"Modal with scroll"));return i.createElement(i.Fragment,null,i.createElement(d.u,{opened:e,onClose:t,title:"Header is sticky",scrollAreaComponent:P.x.Autosize},o),i.createElement(u.z,{onClick:n},"Open modal"))}},N=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
...
`,c={type:"code",code:i,centered:!0,component:function(){let[e,{open:n,close:t}]=(0,a.q)(!1);return o.createElement(o.Fragment,null,o.createElement(l.u,{opened:e,onClose:t,title:"Authentication"},o.createElement(s._,null)),o.createElement(r.z,{onClick:n},"Open modal"))}}},20574:function(e,n,t){"use strict";t.d(n,{_:function(){return l}});var o=t(67294);function l(){return o.createElement("div",null,"Auth form")}},34525:function(e,n,t){"use strict";t.d(n,{C:function(){return m}});var o=t(67294),l=t(22188),r=Object.defineProperty,a=Object.getOwnPropertySymbols,s=Object.prototype.hasOwnProperty,i=Object.prototype.propertyIsEnumerable,c=(e,n,t)=>n in e?r(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t,d=(e,n)=>{for(var t in n||(n={}))s.call(n,t)&&c(e,t,n[t]);if(a)for(var t of a(n))i.call(n,t)&&c(e,t,n[t]);return e};let u={min:-1/0,max:1/0};function m(e=0,n){let{min:t,max:r}=d(d({},u),n),[a,s]=(0,o.useState)((0,l.u)(e,t,r)),i=()=>s(e=>(0,l.u)(e+1,t,r)),c=()=>s(e=>(0,l.u)(e-1,t,r)),m=e=>s((0,l.u)(e,t,r)),p=()=>s((0,l.u)(e,t,r));return[a,{increment:i,decrement:c,set:m,reset:p}]}},78901:function(e,n,t){"use strict";t.d(n,{q:function(){return l}});var o=t(67294);function l(e=!1,n){let{onOpen:t,onClose:l}=n||{},[r,a]=(0,o.useState)(e),s=(0,o.useCallback)(()=>{a(e=>e||(null==t||t(),!0))},[t]),i=(0,o.useCallback)(()=>{a(e=>e?(null==l||l(),!1):e)},[l]),c=(0,o.useCallback)(()=>{r?i():s()},[i,s,r]);return[r,{open:s,close:i,toggle:c}]}}},function(e){e.O(0,[4940,9774,2888,179],function(){return e(e.s=78200)}),_N_E=e.O()}]);