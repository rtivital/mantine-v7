...
`,O={type:"code",component:function(){return i.createElement(c.N,{label:"Your favorite libraries",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],hidePickedOptions:!0})},code:P,maxWidth:340,centered:!0},D=`
...
`,E=({options:e,search:t})=>{let r=t.toLowerCase().trim().split(" ");return e.filter(e=>{let t=e.label.toLowerCase().trim().split(" ");return r.every(e=>t.some(t=>t.includes(e)))})},R={type:"code",component:function(){return i.createElement(c.N,{label:"What countries have you visited?",placeholder:"Pick values",data:["Great Britain","Russian Federation","United States"],filter:E,searchable:!0})},code:D,maxWidth:340,centered:!0},I=`
import { MultiSelect, ComboboxItem, OptionsFilter } from '@mantine/core';
