...
`,D={type:"code",centered:!0,component:function(){let[e,t]=(0,x.useState)(null);return x.createElement(s.l,{value:e,onChange:t,defaultDate:new Date(2022,1),minDate:new Date(2022,1,1),maxDate:new Date(2022,8,1)})},code:M},v=`
import { useState } from 'react';
...
`,b=e=>e.getFullYear()===new Date().getFullYear()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:e.getFullYear()===new Date().getFullYear()+1?{disabled:!0}:{},w=e=>1===e.getMonth()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:5===e.getMonth()?{disabled:!0}:{},Y={type:"code",centered:!0,component:function(){let[e,t]=(0,x.useState)(null);return x.createElement(s.l,{value:e,onChange:t,getYearControlProps:b,getMonthControlProps:w})},code:v},P=`
import { MonthPicker } from '@mantine/dates';

function Demo() {
  return <MonthPicker maxLevel="year" />;
}
`,k={type:"code",centered:!0,component:function(){return x.createElement(s.l,{maxLevel:"year"})},code:P},S=`
import { MonthPicker } from '@mantine/dates';
