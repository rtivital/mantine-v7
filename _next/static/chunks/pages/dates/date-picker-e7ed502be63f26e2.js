...
`,x={type:"code",centered:!0,component:function(){let[e,t]=(0,y.useState)(null);return y.createElement(l.M,{defaultDate:new Date(2015,1),value:e,onChange:t})},code:D},j=`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`,g={type:"code",centered:!0,component:function(){let[e,t]=(0,y.useState)([null,null]),[n,a]=(0,y.useState)(new Date),r=e=>{null!==e[0]&&null===e[1]&&a(e=>new Date(e.getFullYear(),e.getMonth()+1)),t(e)};return y.createElement(l.M,{date:n,onDateChange:a,type:"range",value:e,onChange:r})},code:j};var v=n(74378);let b=`
...
`,_={type:"code",component:function(){return y.createElement(v.Z,{justify:"center"},y.createElement(l.M,{defaultLevel:"decade"}),y.createElement(l.M,{defaultLevel:"year"}))},code:b},w=`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker hideOutsideDates />;
}
`,k={type:"code",centered:!0,component:function(){return y.createElement(l.M,{hideOutsideDates:!0})},code:w},P=`
import { Group } from '@mantine/core';
import { DatePicker } from '@mantine/dates';
...
`,M={type:"code",component:function(){return y.createElement(v.Z,{justify:"center"},y.createElement(l.M,{firstDayOfWeek:0}),y.createElement(l.M,{firstDayOfWeek:6}))},code:P},Y=`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker hideWeekdays />;
}
`,S={type:"code",centered:!0,component:function(){return y.createElement(l.M,{hideWeekdays:!0})},code:Y},L=`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker weekendDays={[1, 2]} />;
}
`,C={type:"code",centered:!0,component:function(){return y.createElement(l.M,{weekendDays:[1,2]})},code:L};var F=n(99040);let E=`
...
`,O=e=>{let t=e.getDate();return y.createElement(F.z,{size:6,color:"red",offset:-5,disabled:16!==t},y.createElement("div",null,t))},N={type:"code",centered:!0,component:function(){return y.createElement(l.M,{renderDay:O})},code:E},z=`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`,I={type:"code",centered:!0,component:function(){let[e,t]=(0,y.useState)(null);return y.createElement(l.M,{value:e,onChange:t,defaultDate:new Date(2022,1),minDate:new Date(2022,1,10),maxDate:new Date(2022,1,25)})},code:z},W=`
import { useState } from 'react';
import { DatePicker, DatePickerProps } from '@mantine/dates';
...
`,H={type:"code",component:function(){return y.createElement(v.Z,{justify:"center"},y.createElement(l.M,{maxLevel:"year"}),y.createElement(l.M,{maxLevel:"month"}))},code:U},R=`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker monthsListFormat="MM" yearsListFormat="YY" />;
}
`,$={type:"code",centered:!0,component:function(){return y.createElement(l.M,{monthsListFormat:"MM",yearsListFormat:"YY"})},code:R},B=`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`,Z={type:"code",centered:!0,component:function(){let[e,t]=(0,y.useState)(null);return y.createElement(l.M,{defaultLevel:"decade",decadeLabelFormat:"YY",yearLabelFormat:"YYYY [year]",monthLabelFormat:"MM/YY",value:e,onChange:t})},code:B};n(64381);let K=`
