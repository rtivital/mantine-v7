...
`,g={type:"code",centered:!0,component:function(){let[e,t]=(0,y.useState)([null,null]),[n,a]=(0,y.useState)(new Date),r=e=>{null!==e[0]&&null===e[1]&&a(e=>new Date(e.getFullYear(),e.getMonth()+1)),t(e)};return y.createElement(d.M,{date:n,onDateChange:a,type:"range",value:e,onChange:r})},code:j};var v=n(74378);let b=`
...
`,C={type:"code",centered:!0,component:function(){return y.createElement(d.M,{weekendDays:[1,2]})},code:L};var F=n(99040);let E=`
...
`,O=e=>{let t=e.getDate();return y.createElement(F.z,{size:6,color:"red",offset:-5,disabled:16!==t},y.createElement("div",null,t))},N={type:"code",centered:!0,component:function(){return y.createElement(d.M,{renderDay:O})},code:E},I=`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`,z={type:"code",centered:!0,component:function(){let[e,t]=(0,y.useState)(null);return y.createElement(d.M,{value:e,onChange:t,defaultDate:new Date(2022,1),minDate:new Date(2022,1,10),maxDate:new Date(2022,1,25)})},code:I},W=`
import { useState } from 'react';
import { DatePicker, DatePickerProps } from '@mantine/dates';
