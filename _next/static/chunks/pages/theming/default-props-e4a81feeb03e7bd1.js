...
`,m=(0,p.j)({components:{Button:a.z.extend({defaultProps:{color:"cyan",variant:"outline"}})}}),h={type:"code",component:function(){return i.createElement(u.M2,{theme:m},i.createElement(l.Z,null,i.createElement(a.z,null,"Default button"),i.createElement(a.z,{color:"red",variant:"filled"},"Button with props")))},centered:!0,code:d};var f=o(35577);let P=`
