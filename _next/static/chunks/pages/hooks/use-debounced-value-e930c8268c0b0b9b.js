...
`,p={type:"code",component:function(){let[e,t]=(0,l.useState)(""),[n]=(0,s.c)(e,200,{leading:!0});return l.createElement(d.x,{maw:400,mx:"auto"},l.createElement(i.o,{label:"Enter value to see debounce effect",placeholder:"Enter value to see debounce effect",value:e,onChange:e=>t(e.currentTarget.value)}),l.createElement(m.x,{mt:"sm"},l.createElement(m.x,{component:"span",c:"dimmed",size:"sm"},"Value:")," ",e.trim()||"[empty string]"),l.createElement(m.x,null,l.createElement(m.x,{component:"span",c:"dimmed",size:"sm"},"Debounced value:")," ",n.trim()||"[empty string]"))},code:h};var v=n(74378),f=n(55899);let x=`
import { useState } from 'react';
import { useDebouncedValue } from '@mantine/hooks';
