...
`,h={type:"code",component:function(){let[e,t]=(0,r.useState)(""),[n]=(0,l.c)(e,200);return r.createElement(s.x,{maw:400,mx:"auto"},r.createElement(d.o,{label:"Enter value to see debounce effect",placeholder:"Enter value to see debounce effect",value:e,onChange:e=>t(e.currentTarget.value)}),r.createElement(i.x,{mt:"sm"},r.createElement(i.x,{component:"span",c:"dimmed",size:"sm"},"Value:")," ",e.trim()||"[empty string]"),r.createElement(i.x,null,r.createElement(i.x,{component:"span",c:"dimmed",size:"sm"},"Debounced value:")," ",n.trim()||"[empty string]"))},code:m},p=`
import { useState } from 'react';
import { useDebouncedValue } from '@mantine/hooks';
import { TextInput, Text } from '@mantine/core';
...
`,v={type:"code",component:function(){let[e,t]=(0,r.useState)(""),[n]=(0,l.c)(e,200,{leading:!0});return r.createElement(s.x,{maw:400,mx:"auto"},r.createElement(d.o,{label:"Enter value to see debounce effect",placeholder:"Enter value to see debounce effect",value:e,onChange:e=>t(e.currentTarget.value)}),r.createElement(i.x,{mt:"sm"},r.createElement(i.x,{component:"span",c:"dimmed",size:"sm"},"Value:")," ",e.trim()||"[empty string]"),r.createElement(i.x,null,r.createElement(i.x,{component:"span",c:"dimmed",size:"sm"},"Debounced value:")," ",n.trim()||"[empty string]"))},code:p};var f=n(74378),x=n(55899);let g=`
import { useState } from 'react';
import { useDebouncedValue } from '@mantine/hooks';
