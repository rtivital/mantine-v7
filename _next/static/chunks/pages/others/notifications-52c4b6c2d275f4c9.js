...
}`,v={type:"code",code:w,component:function(){return c.createElement(f.Z,{justify:"center"},c.createElement(l.z,{variant:"outline",onClick:()=>{Array(10).fill(0).forEach((i,n)=>{r.N9.show({title:`Notification ${n+1}`,message:"Most notifications are added to queue",autoClose:!1})})}},"Show 10 notifications"),c.createElement(l.z,{variant:"outline",color:"gray",onClick:()=>r.N9.cleanQueue()},"Clean queue"),c.createElement(l.z,{variant:"outline",color:"red",onClick:()=>r.N9.clean()},"Clean all"))}};var N=e(16659),b=e(46393);let k=`
