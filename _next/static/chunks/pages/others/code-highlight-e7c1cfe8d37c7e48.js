...
`,m={type:"code",component:function(){return c.createElement(c.Fragment,null,c.createElement(l.P,{code:`// Custom copy label${h}`,language:"tsx",copyLabel:"Copy button code",copiedLabel:"Copied!"}),c.createElement(l.P,{code:`// Without copy button${h}`,language:"tsx",withCopyButton:!1,mt:"md"}))},code:p};var g=o(17192);let f=`
...
`,v={type:"code",component:function(){return c.createElement(g.Q,{code:[{fileName:"Demo.tsx",code:f,language:"tsx"},{fileName:"Demo.module.css",code:x,language:"scss"}]})},code:y};var b=o(88269),C=o(34752);let j=`
function Button() {
  return <button>Click me</button>;
}
`,k=`
...
`,w={type:"code",component:function(){return c.createElement(g.Q,{code:[{fileName:"Button.tsx",code:j,language:"tsx",icon:c.createElement(b.K,{size:18})},{fileName:"Button.module.css",code:k,language:"scss",icon:c.createElement(C.L,{size:18})}]})},code:H};var N=o(24644);let B=`
import { Group, Button, MantineProvider, createTheme } from '@mantine/core';
import classes from './Demo.module.css';
...
`,E={type:"code",component:function(){return c.createElement(g.Q,{withExpandButton:!0,defaultExpanded:!1,expandCodeLabel:"Show full code",collapseCodeLabel:"Show less",code:[{fileName:"Demo.tsx",code:B,language:"tsx"},{fileName:"Demo.module.css",code:I,language:"scss"}]})},code:M};var T=o(77048),P=o(80788);let D=`
