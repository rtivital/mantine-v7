(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5348],{98685:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/others/tiptap",function(){return n(69048)}])},69048:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return Z}});var o=n(85893),i=n(11151),r=n(19905),l=n(9904),c=n(22381),a=n(67294),s=n(45781),d=n(49947),h=n(86873),p=n(86422);let x=`
...
export function validBraces(braces: string) {
  ...
  return opened.length === 0;
}`.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),L={type:"code",component:function(){let e=(0,d.jE)({extensions:[h.Z,f.Z.configure({lowlight:T.$})],content:`<p>Regular paragraph</p><pre><code>${R}</code></pre>`});return a.createElement(s.L,{editor:e},a.createElement(s.L.Toolbar,null,a.createElement(s.L.ControlsGroup,null,a.createElement(s.L.CodeBlock,null))),a.createElement(s.L.Content,null))},code:k};var w=n(50625);let y=`
