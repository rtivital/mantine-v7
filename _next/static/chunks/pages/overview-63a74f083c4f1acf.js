...
`,i={type:"code",component:function(){let[e,n]=(0,s.useState)(""),[t,r]=(0,s.useState)(!1),l=t||e.length>0||void 0;return s.createElement(o.o,{label:"Floating label input",labelProps:{"data-floating":l},classNames:{root:a.root,input:a.input,label:a.label},onFocus:()=>r(!0),onBlur:()=>r(!1),value:e,onChange:e=>n(e.currentTarget.value)})},maxWidth:360,centered:!0,code:[{fileName:"Demo.tsx",language:"tsx",code:r},{fileName:"Demo.module.css",language:"css",code:l}]}},60045:function(e,n,t){"use strict";t.d(n,{W:function(){return r}});var s=t(67294),o=t(11211);let a=`
...
`,r={type:"code",component:function(){return s.createElement(o.m,{defaultValue:"chat",unstyled:!0},s.createElement(o.m.List,null,s.createElement(o.m.Tab,{value:"chat"},"Chat"),s.createElement(o.m.Tab,{value:"gallery"},"Gallery"),s.createElement(o.m.Tab,{value:"account"},"Account")),s.createElement(o.m.Panel,{value:"chat"},"Chat panel"),s.createElement(o.m.Panel,{value:"gallery"},"Gallery panel"),s.createElement(o.m.Panel,{value:"account"},"Account panel"))},code:a}},74445:function(e,n,t){"use strict";t.d(n,{k:function(){return u}});var s=t(67294),o=t(38944),a=t(61736),r=t(11541),l=t(18297),i=t(86186),c=t(80194),d={icon:"mantine-dRAgl7-",dark:"mantine-8SeTy2A",light:"mantine-Fq-223G"};let h=`
...
`,u={type:"code",component:function(){let{setColorScheme:e}=(0,l.X)(),n=(0,i.l)("light",{getInitialValueInEffect:!0});return s.createElement(c.A,{onClick:()=>e("light"===n?"dark":"light"),variant:"default",size:"xl","aria-label":"Toggle color scheme"},s.createElement(a.Z,{className:(0,o.Z)(d.icon,d.light),stroke:1.5}),s.createElement(r.Z,{className:(0,o.Z)(d.icon,d.dark),stroke:1.5}))},centered:!0,code:[{fileName:"Demo.tsx",language:"tsx",code:h},{fileName:"Demo.module.css",language:"css",code:m}]}}},function(e){e.O(0,[7914,4831,7143,9774,2888,179],function(){return e(e.s=92414)}),_N_E=e.O()}]);