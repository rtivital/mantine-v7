...
`,h=(0,o.j)({components:{ActionIcon:a.A.extend({classNames:{root:"mantine-EQzkIkt"}})}}),m={type:"code",component:function(){return r.createElement(i.M2,{theme:h},r.createElement(s.Z,{justify:"center"},r.createElement(a.A,{size:"xxs","aria-label":"Custom xxs size"},r.createElement(c.Z,{style:{width:(0,l.h)(10),height:(0,l.h)(10)}})),r.createElement(a.A,{size:"xxl","aria-label":"Custom xxl size"},r.createElement(c.Z,{style:{width:(0,l.h)(32),height:(0,l.h)(32)}}))))},code:[{fileName:"Demo.module.css",code:u,language:"css"},{fileName:"Demo.tsx",code:d,language:"tsx"}]}},39442:function(e,t,n){"use strict";n.d(t,{j:function(){return l}});var r=n(67294),o=n(51499),a={input:"mantine-d-R5lyp"};let i=`
...
`,c=(0,o.j)({components:{Input:a.I.extend({classNames:{wrapper:"mantine-MLApsb3",input:"mantine-Q3v0IV0"}})}}),d={type:"code",component:function(){return r.createElement(i.M2,{theme:c},r.createElement(a.I,{placeholder:"Size XXL",size:"xxl"}),r.createElement(a.I,{placeholder:"Size XXS",size:"xxs",mt:"md"}))},maxWidth:360,centered:!0,code:[{language:"tsx",code:s,fileName:"Demo.tsx"},{language:"css",code:l,fileName:"Demo.module.css"}]}},67977:function(e,t,n){"use strict";n.d(t,{g:function(){return d}});var r=n(67294),o=n(46393),a=n(43406),i=n(74378);let s=`
...
`,j=e=>{let t=(0,o.B)(e),n=(0,a.E)({color:e.color||e.theme.primaryColor,theme:e.theme});return n.isThemeColor&&"lime"===n.color&&"filled"===e.variant?y(b({},t),{color:"var(--mantine-color-black)"}):"light"===e.variant?{background:(0,i.m)(n.value,.1),hover:(0,i.m)(n.value,.15),border:`${(0,s.h)(1)} solid ${n.value}`,color:(0,l._)(n.value,.1)}:"danger"===e.variant?{background:"var(--mantine-color-red-9)",hover:"var(--mantine-color-red-8)",color:"var(--mantine-color-white)",border:"none"}:t},M={type:"code",component:function(){return r.createElement(c.M2,{theme:{variantColorResolver:j}},r.createElement(d.Z,null,r.createElement(u.z,{color:"lime.4",variant:"filled"},"Lime filled button"),r.createElement(u.z,{color:"orange",variant:"light"},"Orange light button"),r.createElement(u.z,{variant:"danger"},"Danger button")))},centered:!0,code:z}}},function(e){e.O(0,[8969,9341,4831,9774,2888,179],function(){return e(e.s=5413)}),_N_E=e.O()}]);