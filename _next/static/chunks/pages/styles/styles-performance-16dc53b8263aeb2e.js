...
`,a={type:"code",component:function(){return s.createElement(o.x,{className:r.box},"Box component with ",s.createElement("span",{className:r.highlight},"some styles"))},code:[{fileName:"Demo.tsx",language:"tsx",code:i},{fileName:"Demo.module.css",language:"css",code:l}]}},79724:function(e,n,t){"use strict";t.d(n,{W:function(){return l}});var s=t(67294),o=t(43406),r=t(46393);let i=`
...
`,l={type:"code",component:function(){let e="linear-gradient(45deg, var(--mantine-color-pink-filled) 0%, var(--mantine-color-orange-filled) 50%, var(--mantine-color-yellow-filled) 100%)";return s.createElement(o.z,{radius:"md",styles:{root:{padding:(0,r.h)(2),border:0,backgroundImage:e},inner:{background:"var(--mantine-color-body)",color:"var(--mantine-color-text)",borderRadius:"calc(var(--button-radius) - 2px)",paddingLeft:"var(--mantine-spacing-md)",paddingRight:"var(--mantine-spacing-md)"},label:{backgroundImage:e,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}},"Gradient button")},centered:!0,code:i}}},function(e){e.O(0,[2411,7437,9815,9774,2888,179],function(){return e(e.s=95341)}),_N_E=e.O()}]);