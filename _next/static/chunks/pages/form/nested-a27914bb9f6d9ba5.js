...
`,j={type:"code",component:function(){let e=(0,l.c)({initialValues:{terms:!1,user:{firstName:"",lastName:""}}});return i.createElement(c.x,{maw:340,mx:"auto"},i.createElement(m.o,x({label:"First name",placeholder:"First name"},e.getInputProps("user.firstName"))),i.createElement(m.o,x({label:"Last name",placeholder:"Last name",mt:"md"},e.getInputProps("user.lastName"))),i.createElement(u.X,x({label:"I accepts terms & conditions",mt:"sm"},e.getInputProps("terms",{type:"checkbox"}))),i.createElement(d.x,{size:"sm",fw:500,mt:"xl"},"Form values:"),i.createElement(p.E,{block:!0,mt:5},JSON.stringify(e.values,null,2)))},code:b};var k=n(74378),w=n(4741),O=n(4277),I=n(55899),N=n(41249),E=n(89611),M=Object.defineProperty,P=Object.getOwnPropertySymbols,F=Object.prototype.hasOwnProperty,T=Object.prototype.propertyIsEnumerable,S=(e,t,n)=>t in e?M(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,A=(e,t)=>{for(var n in t||(t={}))F.call(t,n)&&S(e,n,t[n]);if(P)for(var n of P(t))T.call(t,n)&&S(e,n,t[n]);return e};let Z=`
import { useForm } from '@mantine/form';
